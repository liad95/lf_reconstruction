...
lf = load_lf_only_data()
display_lf_summed(lf, "LF")

"""phase_mask_finder1 = phase_mask_finder_gd(1000, sampling_dist_mask_plane, sampling_dist_lf_plane, N, wavelength, sigma,
                                          (1601, 1601),
                                          lf.shape, max_sin, L, 100000, 0.001)


phase_mask_finder1.single_iter_test2(lf)"""
n_deltas = 5
max_delta = 1/6
